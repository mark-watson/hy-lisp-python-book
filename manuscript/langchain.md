...
{width: "80%"}
![LangChain architecture: chaining LLMs with embeddings and vector stores](FIG_langchain_examples.jpg)
...
1. **Expand prompt template variables**: In [directions_template.hy](file:///Users/markwatson/GITHUB/hy-lisp-python-book/source_code_for_examples/langchain_examples/directions_template.hy), modify [get_directions](file:///Users/markwatson/GITHUB/hy-lisp-python-book/source_code_for_examples/langchain_examples/directions_template.hy#L6-L17) to take an additional input variable such as `audience` (e.g., "beginner" or "expert"). Change the template structure (for example, `"How do I {thing_to_do} for a {audience}?"`) and update the function to format and pass both variables.
2. **Add custom fields to the template**: Modify [country_information.hy](file:///Users/markwatson/GITHUB/hy-lisp-python-book/source_code_for_examples/langchain_examples/country_information.hy) and its [get_country_information](file:///Users/markwatson/GITHUB/hy-lisp-python-book/source_code_for_examples/langchain_examples/country_information.hy#L10-L22) function to predict not only the capital and population of a country, but also its primary language and currency. Update the template string and verify the generated output.
3. **Index and query custom documents**: Add a new text document of your choice (for example, containing facts about a programming language or an encyclopedia entry) to the [data](file:///Users/markwatson/GITHUB/hy-lisp-python-book/source_code_for_examples/langchain_examples/data) directory. Then, add a corresponding query to the bottom of [doc_search.hy](file:///Users/markwatson/GITHUB/hy-lisp-python-book/source_code_for_examples/langchain_examples/doc_search.hy) to verify that the vector database query matches information from the new document.